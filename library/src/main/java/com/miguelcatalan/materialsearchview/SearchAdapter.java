...
import com.miguelcatalan.materialsearchview.utils.VnStringUtil;
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (!TextUtils.isEmpty(constraint)) {
                    ...
                    for (String string : suggestions) {
                        constraint = VnStringUtil.vnConvert(constraint.toString());
                        if (VnStringUtil.vnConvert(string).toLowerCase().contains(constraint.toString().toLowerCase())) {
